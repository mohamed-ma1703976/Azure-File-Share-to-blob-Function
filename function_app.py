...
def main(mytimer: func.TimerRequest) -> None:
    ...
    try:
        ...
        file_share = ShareClient.from_connection_string(conn_str=file_share_connection_string, share_name="share_name")
    ...
    try:
        ...
        container_client = blob_service_client.get_container_client("container_client_name")
    except Exception as e:
    ...
    def transfer_file(file_item, directory_client, directory_path, container_client, full_path):
        ...
        try:
            metadata = {'original_file_share': "func-qna-deva602", 'original_path': full_path, 'date': current_date.strftime('%Y-%m-%d'), 'transferred': 'true'}
